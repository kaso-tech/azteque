...
-- Le seau `sounds` est créé via l'outil dédié de la plateforme (les
-- insertions directes dans storage.buckets y sont refusées). Les policies
-- ci-dessous en règlent l'accès.
