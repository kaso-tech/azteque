...
Les cartes utilisées sont donc :
...
Premier compte (créant l'atout)

- Compte simple : 4 points

- Compte triple : 5 points

Comptes suivants

- Compte simple : 2 points

- Compte triple : 3 points
...
Le deuxième joueur peut jouer le Valet afin de protéger son 10.
...
**Live app**: https://azteque.lovable.app

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/4a15b175-f308-4e09-9f55-0eddcc127428).
